...
Apps: `TableModel` in `app.py`, then `pxt schema update`. Notebooks / REPL: `create_table`, `add_computed_column`, `add_embedding_index`. This file uses notebook form unless noted. CLI: [cli.md](cli.md). Routes: [workflows.md](workflows.md).
