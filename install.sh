...
install_skill_dir() {
  ...
  if [[ -f "$script_dir/skills/pixeltable-skill/SKILL.md" ]]; then
    ...
    for ref_file in core-api providers workflows video-rag-agents; do
  ...
  echo "  Installed: $skill_dest/reference/ (core-api.md, providers.md, workflows.md, video-rag-agents.md)"
}
